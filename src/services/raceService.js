...
const RACE_COLUMNS =
  'id, datetime, track_variation_id, vehicle_id, tuning, place, lap_time_ms, total_time_ms, performance_index, lap_count, lap_times_ms, results_roster, notes, created_at'
