<template>
  <div class="mb-6 border-t-2 border-brand-strong dark:border-brand-strong-dark">
    ...
    >
      ...
      <span
        class="w-4 h-4 inline-block text-brand-muted dark:text-brand-muted-dark transition-transform"
...
import chevronIcon from '../assets/icons/chevron-down-outline.svg?raw'
